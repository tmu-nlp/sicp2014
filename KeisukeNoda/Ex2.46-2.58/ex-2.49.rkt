...
(define painterA (segments->painter (list (make-segment (make-vect 0 0) (make-vect 1 0))
...
(define painterC (segments->painter (list (make-segment (make-vect 0 0.5) (make-vect 0.5 0))
