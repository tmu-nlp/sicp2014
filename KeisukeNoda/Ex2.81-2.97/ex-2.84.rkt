...
(add (make-rational 8 2) (make-scheme-number 5))
(add (make-complex-from-real-imag 8 2) (make-scheme-number 5))
(add (make-scheme-number 5) (make-complex-from-real-imag 8 2))
(add (make-complex-from-real-imag 5 3) (make-complex-from-real-imag 8 2))