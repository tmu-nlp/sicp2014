  ...
  (segments->painter
     (append (build-segments-list (make-vect 0.0  0.85)
           ...
           (build-segments-list (make-vect 0.25 0.0)
                                ...
                                (make-vect 0.15 0.4)
                                (make-vect 0.0  0.65))
           (build-segments-list (make-vect 0.42 0.78) ;smile
                                (make-vect 0.47 0.75)
                                (make-vect 0.53 0.75)
                                (make-vect 0.58 0.78))
           (build-segments-list (make-vect 0.55 0.9) ;eye
                                (make-vect 0.6 0.9)
                                (make-vect 0.6 0.85)
                                (make-vect 0.55 0.85)
                                (make-vect 0.55 0.9))
...
;((corner-split wave-smile 4) window)
...
((square-limit wave-smile 4) window)
