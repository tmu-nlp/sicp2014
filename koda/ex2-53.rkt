...
(define w24 (make-vect 0.50 0.65));追加
(define w25 (make-vect 0.55 0.70));追加
(define w26 (make-vect 0.45 0.70));追加
...
(define wave 
  (segments->painter 
   (list (make-segment w1 w2)
         ...
         (make-segment w24 w25);追加
         (make-segment w24 w26);追加
         )))
...
(paint (flip-horiz-o wave))
(paint (rotate180-o wave))
(paint (rotate270-o wave))