...
; below 手続きを2通りの手法で実装する

(require (planet "sicp.ss" ("soegaard" "sicp.plt" 2 1)))

; below-a
(define (below-a painter1 painter2)
  (let ((mid-point (make-vect 0.0 0.5)))
    (let ((bottom
...
(define (below-b painter1 painter2)
  (rotation90 (beside (rotation270 painter1) (rotation270 painter2))))
...
(paint wave)
(paint einstein)
(paint (below-a wave einstein))
(paint (below-b wave einstein))
