...
; z = 3 + 4i であるときに (magnitude z) を行ったら
; 5 ではなく error が返ってきた.
; 
; complex パッケージにアクセサを加えると上手く動く, 何故か.
; apply-generic は何回呼ばれるか.
...
| magnitude パッケージのrectanglar が呼ばれる
| 5
5

apply-generic は 始めに car にある
magnitude と complex から探すのでエラーが返ってくる.

apply-generic は 2回呼ばれる.
