...
; ex2.77 のプログラムの書き換え
; type-tag, contents, attach-tag 手続きを書き換える.
; 数値が scheme-number を car に持つペアではなく,
; 普通の数値として出力されるようにする.
; 
...
(add (make-scheme-number 4) (make-scheme-number 3))
(- (make-scheme-number 2) (make-scheme-number 1))
(mul 3 4)